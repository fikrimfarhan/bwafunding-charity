...
{#if data}
    ...
    style="background-image:url('/assets/images/backgrounds/flood.jpg')">
      ...
      <div class="container">
        <div class="color-white xs-inner-banner-content">
          <h2>Donate Now</h2>
          <p>Give a helping hand for disaster victims</p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              ...
              "/assets/images/longsorpondasi.jpeg" class="img-responsive" alt=
              "Family Images"></div>
            </div>
            <div class="col-lg-6">
              <div class="xs-donation-form-wraper">
                ...
                <form action="#" 
                  ...
                  <div class="xs-input-group">
                    ...
                    </label> <input type="text" name="name" id="xs-donate-name" class="form-control" placeholder="Minimum of $5">
                  </div>
                  <!-- .xs-input-group END -->
                  <div class="xs-input-group">
                ...
                <div class="xs-input-group" id="xs-input-checkbox">
                  ...
                  "badge"><i class="fa fa-heart"></i>
                </span> Donate now</button>
                </form>
